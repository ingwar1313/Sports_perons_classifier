...
def classify_image(image_base64_data, file_path = None):
    ...
    for img in imgs:
        ...
        # print(f'array shape : {final.shape}')
        result.append({
...
def get_b64_test_image_for_gamova():
...
if __name__ == '__main__':
    ...
    # print(classify_image(get_b64_test_image_for_gamova(), None))
    # print(classify_image(None, "./test_images/Gamova-glavnaya.jpg"))
    print(classify_image(None, "./test_images/1гамова.jpg"))